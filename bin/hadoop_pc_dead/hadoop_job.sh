...
# hadoop output dir
hadoop_output="${prefix_khan}/app/ecom/fcr/liqibo/NA/mixer_full_charge/${static_date}"
# charge list '\t': total_chrg, bad_chrg
path_local="/home/work/shangbai/online/mixer_full_charge"
...
function run_hadoop(){
	...
	${hadoop_bin} streaming \
		...
		-reducer "python27/bin/python2.7 reducer.py mixer_full" \
		-file "mapper.py" \
		-file "reducer.py" \
		-file "${path_mixer_full}" \
